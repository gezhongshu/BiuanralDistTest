function RIRFileName = my_ISM_RIR_bank(setupstruc,varargin)
...
X_rcv = micpos;
X_src = straj;
fout = fopen(RIRFileName, 'wb');
my_ISM_RoomResp(fout,Fs,beta,rttype,rtval,X_src,X_rcv,room,'SilentFlag',1,'c',cc,'Delta_dB',Delta_dB);
fclose(fout);