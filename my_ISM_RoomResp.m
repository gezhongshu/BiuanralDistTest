function my_ISM_RoomResp(fout,Fs,beta,rt_type,rt_val,X_src,X_rcv,room,varargin)
                ...
                for j = 0:1
                    for k = 0:1
                        ...
                        *beta(2,3)^abs(nz)...
                        ...
                        fwrite(fout, [delp(i0)/Fs, vec(i0,:), gid], 'double');
                    end
                end
            end
        end
...
function [delp, vec] = lthimage(dr, dr0, rl, nr)
% pgm: lthimage
